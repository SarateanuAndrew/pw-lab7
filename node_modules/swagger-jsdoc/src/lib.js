 ...
 * @param {{swaggerDefinition: {servers: [{url: string}], openapi: string, info: {description: string, title: string, version: string}}, apis: string[]}} options - Configuration options
